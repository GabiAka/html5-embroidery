...
if (!window.FileReader) {
  ...
  document
    .getElementById("fileDropBox")
    .addEventListener("drop", handleFileSelection, false);
  document
...
function displayFileText(filename, evt) {
  ...
  } else if (filename.endsWith("zsk") || filename.endsWith("z00")) {
    //NOTE: zsk format commonly uses z + 2 numbers starting with 00
