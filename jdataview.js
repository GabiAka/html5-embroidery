...
(function (global) {
  ...
  if (compatibility.PixelData) {
    ...
    createPixelData.context2d = document
  ...
  function jDataView(buffer, byteOffset, byteLength, littleEndian) {
    ...
    var bufferLength =
      "byteLength" in buffer ? buffer.byteLength : buffer.length;
    this.byteOffset = byteOffset = defined(byteOffset, 0);
    this.byteLength = byteLength = defined(
      byteLength,
